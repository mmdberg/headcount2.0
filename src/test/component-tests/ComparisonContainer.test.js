...
describe ('ComparisonContainer', () => {
  ...
  it('should match the snapshot', () => {
    let wrapper = shallow(<ComparisonContainer selectedCards={mockData} comparison={mockComparison}/>);
  ...
  it('should not do a comparison if stat is not a number', () => {
    ...
    expect(wrapper.find('.district-comparison').text()).toEqual('not comparable to')
  })
